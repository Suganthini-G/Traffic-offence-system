    ...
    if (isset($_POST['submit'])) {
        try {
           ...
           $amount = $_POST['amount'];
            ...
            $insert = "UPDATE fine_details SET amount='$amount' WHERE act_no='$actno'";
                        ...
                        <div class="row mx-0 text-ceneter add-btn" style="max-width: 460px;min-width:360px">
                            <div class="all mx-1 my-1 ">
                                <div class="row justify-content-between pt-3 px-1 mb-4 all">
                                    <div class="col-9">
                                        <h4 class="fw-bold">Update fine details</h4>
                                    </div>
                                    <div class="col-2">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" 
                                    ...
                                    <div class="mb-3 justify-content-between row all btn-rounded py-1">
                                        ...
                                        <input
                                            class="all bg-transparent btn py-2 fw-bolder bg-light btn-light all btn-rounded col-6 "
                                            type="text" name="amount" id="amount" value="<?= $row['amount']; ?>" >
                                    </div>
            ...
            <?php
                    ...
                    ?> <div>
                        ...
                        <div class="row">
                            <div class="col-5"></div>
                            <div class="col-5"></div>
                            <div class="col-2 mt-2 me-0"> <a href="updatefine.php" class="btn btn-info" style="background-color: rgba(0, 0, 0, 0.8); color:azure; width:50%;">Back</a></div>
                        </div>
            <?php
                    }
                } catch (PDOException $e) {
